...
You can safely install via Comfy Manager, without the fear of dependencies brreaking your install. After installation, rename the folder to **ComfyUI-ApoStudio**
