...
My nodes have minimal requirements, so you can safely install via Comfy Manager without the fear of dependencies breaking your entire Comfy. After installation, rename the folder to **ComfyUI-ApoStudio**
